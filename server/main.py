...
from processData import processExcellFile
...
async def create_file(
    ...
    return {
        ...
        "conversionMatrices": processing_result.get("conversionMatrices") if processing_result else {"value":"None"},
...
async def returnType(file_extension, file_object, user_currency="USD"):
    match file_extension:
        case "xlsx" | "xls":
            execution_report = await processExcellFile(
                file_object, 
